...
def make_parser():
    parser = ArgumentParser(description="Train Single Shot MultiBox Detector"
                                        " on COCO")
    parser.add_argument('--data', '-d', type=str, default='/media/mahdi/2e197b57-e3e6-4185-8d1b-5fbb1c3b8b55/datasets/modanet/annotations', required=True,
    ...
    parser.add_argument('--evaluation', nargs='*', type=int, default=[0, 5, 11, 21, 31, 37, 42, 48, 53, 59, 64],
