...
def get_train_loader(args, local_seed):
    ...
    # train_coco_root = os.path.join(args.data, "../fiftyone/coco-2014/validation/data")
...
def get_val_dataset(args):
    ...
    val_annotate = os.path.join(args.data, "instances_val.json")
    val_coco_root = os.path.join(args.data, "data")
